...
prefetch / fastq-dump 请使用 modules/sra-tools/snakemake/local/sra_tools.smk
    ...
    def rule(self, subcommand: str) -> str:
        ...
        if subcommand != "fasterq-dump":
            ...
            return (
                ...
                f"# 实际请使用 modules/sra-tools/snakemake/local/sra_tools.smk（sra-tools_snakemake_local）。\n"
