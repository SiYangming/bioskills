...
命令逻辑迁移自 snakemake.smk/isoseq.smk：
  ...
  - workflow/modules/ultra/snakemake/local/ultra.smk（prepare_genome / prepare_gtf / sort_gtf / ultra_index / ultra_align）
...
# --------------------------------------------------------------------------- #
# versions.yml 兼容（与 isoseq.smk / nf-core 对齐）
# --------------------------------------------------------------------------- #
