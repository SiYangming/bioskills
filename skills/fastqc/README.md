...
```bash
# Native（Agent/CLI）
python skills/fastqc/native/main.py run sample_R1.fq.gz -o qc_out --threads 8 --java-mem-mb 16384

# validate + schema + scan（用 project skill-cli）
python3 skills/bin/skill-cli validate skills/fastqc/native
